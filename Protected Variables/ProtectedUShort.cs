using System;
public partial class ProtectedUShort
{
    private ushort fakeValue1 = 0;
    private decimal protectedValue = 0M;
    private ushort fakeValue2 = 0;
    private int encryptionKey = 0;
    private Random rnd = new Random();
    private ushort fakeValue3 = 0;
    public ProtectedUShort(ushort valueToProtect)
    {
        ...
        protectedValue = ProtectUShort(valueToProtect);
    }
    private decimal ProtectUShort(ushort valueToProtect)
    {
        return (decimal)(valueToProtect * 3 - 50 * encryptionKey);
    }
    private ushort UnprotectUShort(decimal valueToUnprotect)
    {
        decimal coso = ((decimal)valueToUnprotect + (decimal)50.0 * (decimal)encryptionKey) / 3M;
        return ushort.Parse(coso.ToString());
    }
    public ushort GetValue()
    {
        return UnprotectUShort(protectedValue);
    }
    public void SetValue(ushort valueToProtect)
    {
        fakeValue1 = valueToProtect;
        fakeValue2 = valueToProtect;
        fakeValue3 = valueToProtect;
